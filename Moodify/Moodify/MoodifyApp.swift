                ...
                if showSplash {
                    ...
                    if isCreatingNewProfile || !hasCompletedQuestionnaire {
                        ...
                        if navigateToHomePage, let currentProfile = profileManager.currentProfile {
                            ...
                            homePageView(profile: currentProfile, navigateToHomePage: $navigateToHomePage, isCreatingProfile: $isCreatingNewProfile, navigateToMusicPreferences: $navigateToMusicPreferences)  // Pass profile to home page
                                .environmentObject(profileManager)
                        } else {
                            ProfileSelectionView(navigateToHomePage: $navigateToHomePage, isCreatingNewProfile: $isCreatingNewProfile, navigateToMusicPreferences: $navigateToMusicPreferences)
                                .environmentObject(profileManager)
                        }
                    }
                }
