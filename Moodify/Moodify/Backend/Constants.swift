...
let angrySongs: [String: [String]] = [
    "classical": [
        ...
        "6xez71zpAqQ6N5i8E1jHlD",
        "5rPqo5uyPn5MDoJkkiu8Nr",
        "4odlTAKrvaQ4UUJqatxAHt",
        "3lW5j4AqazRxwdVaz4svpZ",
        "1C3RIRKQZhSk5d2iioIhkg",
        "5uVUu68YGnvDJdgTJhJFag",
        "7AGbsC19Ej0kxKvfWj0ptQ",
        "2A7qdr3UNP9Pxjcxa5Jj53",
        "4WJ7UMD4i6DOPzyXU5pZSz"
    ],
    "country": [
        "0ZUo4YjG4saFnEJhdWp9Bt",
        "3z1PqYwMtct2Dm4R9lhWnT",
        "32FcjEWPn4aSRqJ6loL01b",
        "4q5OA5WujXoduN1gvCDCKM",
        "6jXPZid0KLorvgIDP6TiSo",
        "77dcKrzRUI02XjHd2okARp",
        "6VKjdUk3JEbeBXv1IusK5M",
        "5jROdl6MhcmP3O7h2sVgtw",
        "0M7mWKqwTIaVjYyxfZmtTa",
        "7rqaqQurHzR5xHAhdm1gmM"
    ],
    "dance": [
        ...
        "0gpvO8fKvZcQ4u54rdu469",
        "5qFL2uwfnGU8FccwLMgPNQ",
        "097ivRfD5gBHjqhwEMifOT",
        "478zKvO5SlAMJ1dNSn9Dcu",
        "7Em0GU0uX7BzhIzy7V5D9I",
    ...
    "r&b": [
        ...
        "1It1TxBK3xIQAB4xJkPevn",
        "5ctk3VJoHoURSiwkCJn2bf",
        "5Zvp0QO5e9cGhYHywdrfyQ",
        "2OA0iq9hGkvUcS5qA1ZJnU",
        "56z2qI0gKcPthQF6l8AW3E",
...
let chillSongs: [String: [String]] = [
    "classical": [
        "3xGPS59RhE5dNB3yPcMeL6",
        "5NGtFXVpXSvwunEIGeviY3",
        "0M03nhsip3nc39vySJxpSD",
        "1c3GkbZBnyrQ1cm4TGHFrK",
        "2GB0j6BKunT9pWbzan5HD6",
        "3jLcwFns5S9OYQojN8XAkJ",
        "5t9UkwkrumEmOpnz3SRdbm",
        "1Xf4sNtMKc1xiUhuIPAUg2",
        "0awWxz7WRKdSpU9RVZ5PVK",
        "1wglWrfecdrCSX5NIHlYc8"
    ],
    "country": [
        "4S518ci8UY4op0Xyp6Hx6o",
        "3MpK9vnxxgYvh0CNeGvx6G",
        "6ET9kf9riLETWs9lePUEAI",
        "1XazlqB4YAtvouCmJPWXlM",
        "4YjjNHtEsTX6Af4mCTupT5",
        "4gzeYkzuzxuzAUTsGcdjqA",
        "1t2hJFgJyUPD2crOafMUEk",
        "5BeY2wY4rGFD1Q3aXO83Bv",
        "05ZACkzW8YbRq3eFgIfSNB",
        "6frDDMJeVZPcjhoDfqdRIW"
    ],
    "dance": [
        "12GEpg2XOPyqk03JZEZnJs",
        "2WWfjbHALIb3e7FMcj9mr4",
        "0hNduWmlWmEmuwEFcYvRu1",
        "4lAnj7Git7s2QrSTwUa54g",
        "2GQEM9JuHu30sGFvRYeCxz",
        "6YFRyll4isFUJrbHSeM1oJ",
        "4xs3eeuZb1WofrjlUp65QP",
        "2lJ4d8MCT6ZlDRHKJ1br14",
        "5MhMXTuVODDF234VDvSxQx",
    ...
    "rock": [
        "2dphvmoLEXdk8hOYxmHlI3",
        "4M4Q3JLsUbyTkd5WHty1WB",
...
let happySongs: [String: [String]] = [
    "classical": [
        ...
        "3RUBMVfbweULyfoVMXTOLV",
        // Mozart – Eine kleine Nachtmusik
        "4KLVPRo0f6XUJa4t4dnRW6",
        // Beethoven – Symphony No. 9: Ode to Joy
        "4Nd5HJn4EExnLmHtClk4QV",
        // Handel – Water Music: Hornpipe
        "6Xq59xlhj1LzqfkU2BlPx3",
        // Tchaikovsky – Dance of the Sugar Plum Fairy
        "4QTFU7BukoyDtyyemGPNCX",
        // Rossini – The Barber of Seville Overture
        "3PGPfeQTaZgHnmofWYBHSW",
        // Johann Strauss II – The Blue Danube
        "1m9HmCTEt8DyAyGo1de50h",
        // Elgar – Pomp and Circumstance
        "0GXJ6r9aHj0Lx6ADBiCj9E",
        // Bizet – Carmen: Les Toreadors
        "6Z34YgqCJkdrliDmbcaJgy",
        // Mendelssohn – Wedding March
        "6CyhZwhS6eG1UVeNv6N7VS"
    ],
    "country": [
        "0JbSghVDghtFEurrSO8JrC",
        "0LQtEJt7x0s6knb6RKdRYc",
        "6sxptembJVty4sNtcPMAVz",
        "1dgWTMoHwTUnQhOQ8SR5fV",
        "0i5el041vd6nxrGEU8QRxy",
        "1dyxS3YzBbL0t8rEVwVQ1K",
        "0b9djfiuDIMw1zKH6gV74g",
        "4CLPNURPcKztF9RRdcWLGP",
        "7qXPZxXn6Xmv1sjh03skiW",
...
let sadSongs: [String: [String]] = [
    "classical": [
        ...
        "3ilnnpmMMpp863r2X0EHQK",
        // Chopin – Nocturne in C-sharp Minor
        "2MSgFefjK0T7Iwjvr3OKqV",
        // Bach – Adagio from Concerto for Oboe and Violin
        "1v3gGmcneK1QzYyBFiBXG0",
        // Mahler – Symphony No. 5: Adagietto
        "1Z1DK8nlqNmV9RywT9QRCB",
        // Rachmaninoff – Piano Concerto No. 2: Adagio sostenuto
        "4rrrn8OLrttq7r9RgNXalU",
        // Barber – Adagio for Strings
        "1CSaCKPIp2yCIDL3t7Fyau",
        // Debussy – Clair de Lune
        "5u5aVJKjSMJr4zesMPz7bL",
        // Tchaikovsky – Swan Lake Theme
        "5tNUaNoIMdJcdHGj25a7gD",
        // Schubert – Ave Maria
        "4JsMpgsep6XpuHSzKCTxCz",
        // Albinoni – Adagio in G Minor
        "2AjyreHCD6PKAtRGV2qsK5"
    ],
    "country": [
        "5aDK0TurEtiedVdT0a6k9a",
        "2SpEHTbUuebeLkgs9QB7Ue",
        "4bVuIlGQBMWS7vIhcx8Ae4",
        "02eD9ymfJOJOhM97HYp5R9",
        "0d6RyijW7XpWWD2m81uwHO",
        "4pJi1rVt9GNegU9kywjg4z",
        "3aPu8Pt9F18y7O7AbzsC02",
        "3opmoDn4nG2eZWPjI8B7Bg",
        "4BXkf6yww23Vdju7E1fUrn",
        "6qMgx8ys4MNNxypaIvbG0i"
    ],
    "dance": [
        "59wlTaYOL5tDUgXnbBQ3my",
        "14gdERIqymApVn9vcsbmZ3",
        "0Zbbxnx4SGGHoIow4PpISP",
        "6RUKPb4LETWmmr3iAEQktW",
        "7gHs73wELdeycvS48JfIos",
        "4Gcv5SsxnQWpmOnUI19EJk",
        "3NRDLYyqIXja0UElvdzjkB",
        "3nPpCn5nYTMg0ajmzv57Jq",
...
/*
 ...
 Holst – Mars, the Bringer of War (The Planets)
